...
from ali import (build_discriminator as build_mine_discriminator,
                 build_extra_networks, score, apply_penalty)
from featnet import (apply_gradient_penalty, build_encoder,
                     build_discriminator as build_noise_discriminator,
...
def encoder_routine(data, models, losses, results, viz, mine_measure=None, noise_measure=None,
    ...
    E_pos, E_neg, P_samples, Q_samples = score(models, X_P, X_Q, Z, Z, mine_measure,
                                               key='mine_discriminator')
...
def mine_discriminator_routine(data, models, losses, results, viz, mine_measure='JSD',
    ...
    penalty = apply_penalty(models, losses, results, X_P, Z, mine_penalty_amount,
                            key='mine_discriminator')
...
def BUILD(data, models, encoder_type='convnet', decoder_type='convnet', encoder_args={},
          decoder_args={}, noise_parameters=dict(concentration=0.1), noise_type='dirichlet'):
