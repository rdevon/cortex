...
def encoder_routine(data, models, losses, results, viz, mine_measure=None, noise_measure=None, noise_type='hypercubes',
    ...
    get_results(P_samples, Q_samples, E_pos, E_neg, mine_measure, results=results)
...
def mine_discriminator_routine(data, models, losses, results, viz, measure=None, penalty_amount=None, output_nonlin=False,
    ...
    losses.update(mine_discriminator=E_neg - E_pos)
...
ROUTINES = dict(mine_discriminator=mine_discriminator_routine, noise_discriminator=noise_discriminator_routine,
...
DEFAULT_CONFIG = dict(
    ...
    optimizer=dict( optimizer='Adam', learning_rate=1e-4,
                    updates_per_model=dict(noise_discriminator=1, mine_discriminator=1, autoencoder=1, classifier=1)),
    ...
    routines=dict(mine_discriminator=dict(measure='JSD', penalty_amount=0.5),
                  noise_discriminator=dict(measure='JSD', penalty_amount=0.5),
