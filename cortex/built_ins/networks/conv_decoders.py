...
class MNISTDeConv(nn.Module):
    ...
    def __init__(self,
        ...
        models.add_module('deconv1',
                          nn.ConvTranspose2d(2 * dim_h, dim_h, 4, 2, 1))
    ...
    def __init__(self,
        ...
        for i in range(n_steps):
            ...
            models.add_module(
                name,
                nn.ConvTranspose2d(
                    dim_in, dim_out, f_size, stride, pad, bias=False))
        ...
        models.add_module(name + 'f',
                          nn.Conv2d(dim_out, dim_out_, 3, 1, 1, bias=False))
