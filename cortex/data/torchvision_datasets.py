...
class TorchvisionDatasetPlugin(DatasetPlugin):
    ...
    def _handle_LSUN(self, Dataset, data_path, transform=None):
        ...
        test_set = Dataset(data_path, classes=['bedroom_test'], transform=transform)
        return train_set, test_set

    def _handle_SVHN(self, Dataset, data_path, transform=None):
        train_set = Dataset(data_path, split='train', transform=transform, download=True)
        test_set = Dataset(data_path, split='test', transform=transform, download=True)
        return train_set, test_set
