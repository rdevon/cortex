...
from cortex.nets.ali import build_extra_networks, network_routine, apply_penalty
from cortex.nets.featnet import get_results, score, visualize, build_encoder
from cortex.nets.gan import generator_loss, apply_gradient_penalty
...
def encoder_routine(data, models, losses, results, viz, mine_measure=None, noise_measure=None,
    ...
    :param noise_measure:
    :type noise_measure:
    :param encoder_penalty_amount:
    :type encoder_penalty_amount:
...
def mine_discriminator_routine(data, models, losses, results, viz, mine_measure='JSD', mine_penalty_amount=0.5):
    ...
    :param mine_measure:
    :type mine_measure:
    :param mine_penalty_amount:
    :type mine_penalty_amount:
    """
...
def noise_discriminator_routine(data, models, losses, results, viz, noise_penalty_amount=0.5, noise_measure='JSD'):
    ...
    :param viz:
    :type viz:
    :param noise_penalty_amount:
    :type noise_penalty_amount:
    :param noise_measure:
    :type noise_measure:
    """
...
def build_mine_discriminator(models, x_shape, dim_l, Encoder, key, param):
    """
    TODO
    :param models:
    :type models:
...
def build_noise_discriminator(models, dim_l, key):
    """
    TODO
    :param models:
    :type models:
