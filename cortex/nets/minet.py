...
from cortex.nets.adversarial_autoencoder import encode
from cortex.nets.adversarial_clustering import build_noise_discriminator
from cortex.nets.ali import score, apply_penalty, build_discriminator, build_extra_networks
from cortex.nets.classifier import classify
from cortex.nets.featnet import get_results, visualize, shape_noise, build_encoder
