...
def routine(self, data: int, models, losses, results, viz, key='classifier', criterion=None):
    ...
    self.visualize(inputs, targets, predicted, viz=viz)
...
def build_model(data, models, model_type='convnet', dropout=0.2, classifier_args=None):
    ...
    if model_type == 'resnet':
        from cortex.models import ResEncoder, Encoder
        args = resnet_args_
    elif model_type == 'convnet':
        from cortex.models import SimpleConvEncoder as Encoder
        args = convnet_args_
