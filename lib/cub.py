...
def make_dataset(_dir, class_to_idx, indices, boxes):
...
class CUB(data.Dataset):
    ...
    def __init__(
        ...
        assert(split_type in ['train', 'test', 'full'])
        ...
        if isinstance(seed, int):
            ...
            permuted_indices = list(rand_state.permutation(len(classes)))
            ...
            train_indices = permuted_indices[:cub_standard_split]
            test_indices = permuted_indices[cub_standard_split:]
